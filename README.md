...
* in these fields and accessor methods that return the values in these fields.
* Once you have written the class, write a separate program that creates 3 RetailItem objects & stores 
* the following data in them:

Item #      Description 		Units 	        Price
------------------------------------------------------			
Item #1 	Jacket 				12 				59.95
Item #2 	Designer      40 				34.95
Item #3 	Shirt 				20 				24.95
=============================================================================================================
*/
```

<sub>Exercise taken from "Starting Out With Java", 4ed. Gaddis</sub>
